...
MERGED_PATH = Path("final_announcement.json")  # change if your file lives elsewhere
...
result = evaluate(dataset=evaluation_dataset,metrics=[AnswerCorrectness(), AnswerSimilarity()],llm=evaluator_llm)
print(result)