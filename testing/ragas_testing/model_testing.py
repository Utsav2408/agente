...
MERGED_PATH = Path("model_test.json")  # change if your file lives elsewhere
...
from ragas.metrics import AnswerCorrectness, ResponseRelevancy, AnswerSimilarity

result = evaluate(dataset=evaluation_dataset,metrics=[AnswerCorrectness(), ResponseRelevancy(), AnswerSimilarity()],llm=evaluator_llm)
print(result)